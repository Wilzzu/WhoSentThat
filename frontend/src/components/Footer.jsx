		...
		<footer>
			...
			<Modal open={open} onClose={() => setOpen(false)} classNames={{ modal: "customModal" }}>
				<span className="gdpr font-poppins text-blackish">
					...
					<h2>Introduction</h2>
					<p>
						This website, whosentthat.wilzzu.dev, values your privacy. This policy explains our use
						of local storage and cookies, and how we use third party services to provide a
						functional and secure website experience.
					</p>
					<br />
					...
					<p>
						Cookies are small files that are stored on your device when you visit a website. They
						are used to remember your preferences and provide a personalized experience.
					</p>
					...
					<p>
						You can adjust your browser settings to manage or delete cookies. Note that disabling
						them may prevent some website functionality.
					</p>
					<br />
					...
					<h3>Cloudflare</h3>
					<p>
						We use Cloudflare for website protection and performance optimization. Cloudflare may
						use cookies to manage website protection and performance. For details, please refer to{" "}
					...
					<h2>Data Security</h2>
					<p>
						We take data security seriously and have implemented measures to protect your data. We
						use secure and trusted third-party services to handle user data and website protection.
					</p>
					<br />
